...
To run the scripts above with the data provided, do not forget to change the inputpath in the beginning of the scripts! The .ipynb files can be run by launching a JupyterLab instance in this folder after downloading it. Instructions to install JupyterLab can be found here: https://jupyter.org/install.
